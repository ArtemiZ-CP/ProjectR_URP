...
namespace CharacterCustomization
{
    public class CharacterCustomizationWindow : EditorWindow
    {
        ...
        private const string MaterialPath = "Assets/Source/Gameplay/Player/Customisation/Materials/Main_Material.mat";
        private const string PartsPath = "Assets/Source/Gameplay/Player/Customisation/Meshes";
        private const string FbxPath = "Assets/Source/Gameplay/Player/Customisation/Meshes/Basic_Character.fbx";
        private const string AnimationControllerPath = "Assets/Source/Gameplay/Player/Animations/Animation controller.controller";
